...
@Slf4j
public class CombinacaoQuinaItemReader implements ItemReader<List<Integer>> {
    ...
    public CombinacaoQuinaItemReader(List<QuinaModel> historico, int totalJogosAGerar) {
    ...
    private List<Integer> gerarCombinacaoBaseadaHistorico(List<QuinaModel> historico) {
