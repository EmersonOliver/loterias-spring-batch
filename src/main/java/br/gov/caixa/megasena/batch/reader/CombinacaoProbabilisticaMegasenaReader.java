...
@Slf4j
public class CombinacaoProbabilisticaMegasenaReader implements ItemReader<List<Integer>> {
    ...
    public CombinacaoProbabilisticaMegasenaReader(List<MegasenaModel> historico) {
    ...
    private Map<Integer, Double> calcularProbabilidades(List<MegasenaModel> historico) {
